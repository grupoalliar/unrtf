...
/*
static int
cmd_sb(Word *w, int align, char has_param, int num)
{
  int pt_relation = 20;
	char str[30];
  ...
  int height = num/pt_relation;

	snprintf(str, 30, "%i", height);
	attr_push(ATTR_SPACE_BEFORE, str);
...
/*========================================================================
 * Name:	cmd_sa
 * Purpose:	Executes the \sa command.
 * Args:	Word, paragraph align info, and numeric param if any.
 * Returns:	Flag, true only if rest of Words on line should be ignored.
 *=======================================================================*/
/*
static int
cmd_sa(Word *w, int align, char has_param, int num)
{
  int pt_relation = 20;
	char str[30];
  ...
  int height = num/pt_relation;
	...
	snprintf(str, 30, "%i", height);
	attr_push(ATTR_SPACE_AFTER, str);
...
/*========================================================================
 * Name:	cmd_v
 * Purpose:	Executes the \v command.
 * Args:	Word, paragraph align info, and numeric param if any.
 * Returns:	Flag, true only if rest of Words on line should be ignored.
 *=======================================================================*/

static int
cmd_v(Word *w, int align, char has_param, int num)
{
	attr_push(ATTR_HIDDEN_TEXT, "");
...
starting_paragraph_align(int align, char* space_before, char* space_after, char* line_height)
{
	...
	{
	case ALIGN_CENTER:
		if (safe_printf(4, op->center_begin, space_before, space_after, sl_str, padding))
		{
